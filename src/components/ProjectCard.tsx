...
export function ProjectCard({ repo, index }: ProjectCardProps) {
  ...
  return (
    <article
      className="opacity-0 group relative glass-card rounded-xl p-4 transition-all duration-500 hover-glow-effect hover:border-primary/40 hover:-translate-y-1 animate-fade-up"
    ...
    >
      ...
      <div className="relative z-10">
        <div className="flex items-start justify-between mb-3">
          <h3 className="text-base font-semibold text-white group-hover:text-primary transition-colors duration-300 line-clamp-1">
            {repo.name.replace(/-/g, " ")}
          </h3>
